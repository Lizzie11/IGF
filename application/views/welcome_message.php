...
<div class="box box-success">
    ...
    <div class="box-body chat" id="chat-box">
        ...
        <!-- chat item -->
        <div class="item">
            <img src="<? echo base_url("dist/img/user3-128x128.jpg")?>" alt="user image" class="offline">
        ...
        <!-- chat item -->
        <div class="item">
            <img src="<? echo base_url("dist/img/user2-160x160.jpg");?>" alt="user image" class="offline">
